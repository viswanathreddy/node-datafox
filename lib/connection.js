...
var SimilarCompanies = require('./similar_companies');
...
var Connection = function(opts) {
  ...
  this.similarCompanies = new SimilarCompanies(this);
  var self = this;
...
Connection.prototype._refreshAccessToken = function(callback) {
  var opts = {
    method: 'POST',
    url: '/oauth2/token',
    form: {
